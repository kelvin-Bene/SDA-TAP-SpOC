...
def batchPull(code,start_epoch,end_epoch,UDL_token):
    ...
    sensor_types = [key for key, value_list in code.sensor_superiors.items() if code.SensorType in value_list]
    print(sensor_types)
    ...
    for sensor_type in sensor_types:
        ...
        for regime in regimes:
            ...
            while steps<batchsize:
                ...
                final_dict['obTime']=UDL.datetime_to_UDL(start_time+steps)+'..'+UDL.datetime_to_UDL(start_time+dt.timedelta(minutes=10)+steps)
