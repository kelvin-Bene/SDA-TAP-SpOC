...
import pandas as pd
import os
from libraries.windowTools import setRecycler,codeGenerator, createDatasetCodeGUI, DatasetCode
...
existing_sets = [DatasetCode(set) for set in pd.read_csv('data/dummy_database.csv')]
...
#read satellite objecy type info
candidate_objects = pd.read_csv('data/satelliteData.csv')  
