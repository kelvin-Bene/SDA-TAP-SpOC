...
const SERVICE_FORM_CONFIGS: Record<string, ServiceFormConfig> = {
  ...
  satnogs: {
    service_name: 'satnogs',
    label: 'SatNOGS Network',
    primaryLabel: 'API Token',
    primaryPlaceholder: 'SatNOGS API token',
    helpUrl: 'https://network.satnogs.org',
    helpText: 'Get your API token from the SatNOGS dashboard.',
  },
  celestrak: {
    service_name: 'celestrak',
    label: 'CelesTrak',
    primaryLabel: 'API Token',
    primaryPlaceholder: 'CelesTrak API token',
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                id="primary"
                type={isPath ? 'text' : (showPrimary ? 'text' : 'password')}
