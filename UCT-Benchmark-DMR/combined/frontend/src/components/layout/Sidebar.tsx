      ...
      <div className="space-y-1">
        <button
          ...
          className={cn(
            ...
            hasActiveChild
              ? 'bg-primary/15 text-foreground border border-primary/30 shadow-sm shadow-primary/10'
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <>
      ...
      >
        {/* Glass background */}
        <div className="absolute inset-0 bg-background/90 backdrop-blur-xl border-r border-white/10" />
          ...
          <ScrollArea className="flex-1 px-4 py-6 scrollbar-thin">
            ...
            <div className="mt-8 space-y-3">
              ...
              <Link to="/datasets/generate">
                <Button
                  variant="outline"
                  className="w-full justify-start gap-3 border-dashed border-white/10 bg-white/[0.03] hover:bg-primary/10 hover:border-primary/30 text-foreground transition-all duration-200"
                >
              ...
              <Link to="/submit">
                <Button
                  variant="outline"
                  className="w-full justify-start gap-3 border-dashed border-white/10 bg-white/[0.03] hover:bg-secondary/10 hover:border-secondary/30 text-foreground transition-all duration-200"
                >
