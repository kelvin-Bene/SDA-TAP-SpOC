...
const educationContent: Record<string, StepEducation> = {
  ...
  cluster: {
    ...
    learnMore:
      'This is the core challenge in UCT processing. The algorithm must determine which observations come from the same satellite despite gaps, noise, and similar-looking tracks.',
    variant: 'concept',
  },
  iod: {
