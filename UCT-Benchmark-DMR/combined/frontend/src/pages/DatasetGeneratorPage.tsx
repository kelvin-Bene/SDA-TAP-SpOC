      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-cosmic-cyan/5 via-transparent to-stellar-purple/5 p-6 sm:p-8">
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground mt-2 max-w-2xl">
            ...
            a custom UCTP benchmark dataset for algorithm evaluation.
          </p>
        </div>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <InfoPopover
                  ...
                  learnMore="The orbital regime fundamentally affects the difficulty of the UCTP (Uncorrelated Track) processing problem. LEO objects generate many short observation tracks due to fast motion, requiring algorithms to associate observations across passes. GEO objects are nearly stationary but faint, creating a different association challenge. HEO objects have the most complex dynamics and are the hardest to track."
                  variant="concept"
                  size="md"
                  docsLink="/docs"
