      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-stellar-purple/5 via-transparent to-cosmic-cyan/5 p-6 sm:p-8">
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Everything you need to understand the SpOC UCT Benchmark Platform &mdash; from
        ...
        <TabsContent value="getting-started" className="space-y-6">
          ...
          <Card className="border-white/10">
            <CardHeader>
              ...
              <CardDescription>
                Five steps to evaluate your UCT processing algorithm
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'Process the observations with your UCT algorithm to produce track associations and state estimates for each identified object.',
                    color: 'blue',
                  },
                  {
                    step: 4,
          ...
          <Card className="border-white/10">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground leading-relaxed">
                The UCTP Lab provides an integrated environment for running, testing, and comparing
                UCT processing algorithms. It includes a visual pipeline builder, ML training studio,
                and API connectivity testing.
              </p>
              <div className="grid sm:grid-cols-3 gap-3">
                <ConceptCard
                  title="Algorithm Workbench"
                  description="Configure and run the full UCTP pipeline: ingest, cluster, IOD, refine, output."
                  icon={FlaskConical}
                  color="cyan"
                />
                <ConceptCard
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  <div className="text-xs text-muted-foreground bg-white/[0.05] rounded-lg p-2 border border-white/5">
                    <span className="font-medium text-foreground/80">UCT Challenge:</span> Many short tracks from fast-moving objects. Must associate observations across multiple passes.
                  </div>
                </ConceptCard>
                ...
                >
                  <div className="text-xs text-muted-foreground bg-white/[0.05] rounded-lg p-2 border border-white/5">
                    <span className="font-medium text-foreground/80">UCT Challenge:</span> Moderate dynamics. Longer observation arcs but fewer objects per sensor field of view.
                  </div>
                </ConceptCard>
                ...
                >
                  <div className="text-xs text-muted-foreground bg-white/[0.05] rounded-lg p-2 border border-white/5">
                    <span className="font-medium text-foreground/80">UCT Challenge:</span> Faint targets clustered in longitude slots. Must resolve closely-spaced objects at extreme range.
                  </div>
                </ConceptCard>
                ...
                >
                  <div className="text-xs text-muted-foreground bg-white/[0.05] rounded-lg p-2 border border-white/5">
                    <span className="font-medium text-foreground/80">UCT Challenge:</span> Complex non-circular dynamics. Observation geometry changes dramatically across the orbit.
                  </div>
                </ConceptCard>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    detail: 'Clustering algorithms (e.g., DBSCAN, MHT, GNN) identify which observations belong together. This is the core association problem \u2014 the most challenging step in UCT processing.',
                    color: 'purple',
                  },
                  {
