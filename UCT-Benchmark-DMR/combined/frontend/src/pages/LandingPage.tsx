        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pt-20">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6" style={{ animation: 'slide-up-fade 0.6s ease-out both', animationDelay: '0.1s' }}>
              <span className="text-gradient-cosmic">UI</span>
              <br />
              <span className="text-foreground/90 text-3xl sm:text-4xl md:text-5xl font-semibold">UCTP Benchmarking</span>
              <br />
      ...
      <section id="guide" className="relative" ref={timelineRef}>
        ...
        <div className="max-w-4xl mx-auto text-center px-6 pt-24 pb-8">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            From raw space surveillance data to standardized algorithm evaluation — five phases to benchmark any UCTP processor.
          </p>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <PipelineStep
            ...
            description="Upload your UCTP processor, configure pipeline parameters, and run against any benchmark dataset. Supports custom clustering, IOD, and refinement modules."
      ...
      <section id="features" className="relative py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              A complete environment for developing, testing, and benchmarking UCTP processing algorithms.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <FeatureCard
              ...
              description="Upload your UCTP processor with drag-and-drop. Configure clustering, IOD, and refinement parameters before running against any benchmark."
              delay={100}
            />
            <FeatureCard
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-display font-bold text-sm">
                <span className="text-gradient-cosmic">UI</span>
                <span className="text-muted-foreground ml-2 font-normal">UCTP Benchmark</span>
              </span>
            </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground text-lg max-w-lg mx-auto mb-8">
        Sign in to access the platform, browse datasets, submit your UCTP processor, and see how it performs against the community.
      </p>
