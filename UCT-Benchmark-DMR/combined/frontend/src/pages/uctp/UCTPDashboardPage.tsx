  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-stellar-purple/5 via-transparent to-cosmic-cyan/5 p-6 sm:p-8">
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Configure, run, and compare UCT processing algorithms. Train ML
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatBox
          ...
          popover={
            <InfoPopover
              title="Total Runs"
              description="Each run executes the full UCTP pipeline on a dataset, including clustering, initial orbit determination, and optional refinement."
              details={[
                'A run processes raw UCT observations through the entire pipeline',
        ...
        <StatBox
          ...
          popover={
            <InfoPopover
              title="ML Models"
              description="Machine learning models can enhance UCT processing by improving clustering accuracy and orbit propagation predictions."
              details={[
        ...
        <StatBox
          ...
          popover={
            <InfoPopover
              title="API Health"
              description="Indicates the availability of external services that the UCTP pipeline depends on for orbit determination and propagation."
              details={[
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <QuickActionCard
            ...
            description="Configure clustering, IOD, and refinement parameters then execute the full UCTP pipeline against any dataset."
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <StepExplainer
        title="UCTP Lab Workflow"
        description="The typical workflow for testing and improving your UCT processing algorithm."
        tips={[
          'Start in the Algorithm Workbench to configure and run the UCTP pipeline',
