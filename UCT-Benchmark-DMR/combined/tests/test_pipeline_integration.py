...
class TestApplyDownsampling:
    ...
    def test_seed_provides_reproducibility(self, sample_observations, sample_sat_params):
        ...
        result1, _ = apply_downsampling(sample_observations.copy(), sample_sat_params, config=config1)
        result2, _ = apply_downsampling(sample_observations.copy(), sample_sat_params, config=config2)
        result3, _ = apply_downsampling(sample_observations.copy(), sample_sat_params, config=config3)
...
class TestApplySimulationToGaps:
    ...
    def test_returns_empty_metadata_for_empty_input(self):
        ...
        result_df, metadata = apply_simulation_to_gaps(
            empty_df, empty_elset, pd.DataFrame()
        )
    ...
    def test_metadata_contains_counts(self, sample_observations, sample_elset_data, sample_sensor_df):
...
class TestBackwardCompatibility:
    ...
    def test_existing_downsampling_functions_unchanged(self, sample_observations, sample_sat_params):
