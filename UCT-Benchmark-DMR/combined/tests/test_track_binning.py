...
class TestBinTracks:
    ...
    def test_bin_tracks_empty_input(self, sample_state_vectors):
        ...
        empty_obs = pd.DataFrame(columns=[
            'id', 'obTime', 'satNo', 'idSensor', 'senlat', 'senlon', 'senalt', 'ra', 'declination'
        ])
...
class TestRegimeProfiles:
    ...
    def test_get_regime_profile_geo(self):
        ...
        assert profile['min_coverage_pct'] != leo_profile['min_coverage_pct'] or \
               profile['max_track_gap_periods'] != leo_profile['max_track_gap_periods']
