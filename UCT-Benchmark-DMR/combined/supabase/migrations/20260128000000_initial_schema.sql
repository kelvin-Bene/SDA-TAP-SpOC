...
--
-- Direct conversion from DuckDB schema.py v1.3.0
...
--
-- Run: npx supabase db reset (from UCT-Benchmark-DMR/combined/)
-- ============================================================
...
-- ============================================================
-- 8. DATASET <-> OBSERVATION JUNCTION
-- ============================================================
...
CREATE TABLE IF NOT EXISTS jobs (
    ...
    stage           VARCHAR(200),                    -- Current stage for progress display
    result          JSONB,
    error           TEXT,
    metadata        JSONB,
    created_at      TIMESTAMPTZ DEFAULT NOW(),
...
-- ============================================================
-- 13. VALIDATION MEASUREMENTS (ILRS Ground Truth)
-- ============================================================
...
-- ============================================================
-- 20. CREDENTIALS (encrypted credential storage)
-- ============================================================
