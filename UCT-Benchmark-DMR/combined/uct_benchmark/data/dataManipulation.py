# -*- coding: utf-8 -*-
"""
Data Manipulation Module - UCT Benchmark Dataset Generation

This module implements Louis's canonical 3-stage downsampling pipeline:
...
Primary entry point: apply_downsampling()
Canonical pipeline: downsampleData()
Fallback strategy: downsample_by_regime()

Experimental and research strategies have been moved to
dataManipulation_experimental.py. They are re-exported here for
...
# === HELPER FUNCTIONS ===
# =============================================================================
# Shared track identification, orbital regime detection, and geometry helpers.
...
# =============================================================================
# === CANONICAL 3-STAGE PIPELINE (Louis's Reference Design) ===
# =============================================================================
# Stage 1: _lowerOrbitCoverage  - Remove tracks to achieve target coverage %
# Stage 2: _increaseTrackDistance - Increase gaps between tracks to target gap size
# Stage 3: _downsampleAbsolute   - Cap observations per satellite
#
# Orchestrated by downsampleData(), called via apply_downsampling().
# =============================================================================
...
def downsampleData(
    ...
    """Louis's canonical 3-stage downsampling pipeline.

    This is the PRIMARY downsampling strategy, implementing the exact pipeline
    described in Louis's UCT Benchmark specification:
      Stage 1: Coverage Reduction - Remove tracks to achieve target coverage %
      Stage 2: Gap Widening - Increase gaps between tracks to target gap size
      Stage 3: Observation Count Reduction - Cap observations per satellite
...
# =============================================================================
# apply_downsampling() - Primary entry point for the canonical pipeline
# apply_simulation_to_gaps() - Gap-filling with synthetic observations
# =============================================================================
...
# =============================================================================
# generate_dataset_with_lewis_tiers() - Full pipeline with window selection
# generate_dataset_with_non_reference() - Extended dataset with True Negatives
# =============================================================================

# Import Lewis tier classification from experimental module.
# These are used by generate_dataset_with_lewis_tiers() below.
from uct_benchmark.data.dataManipulation_experimental import (  # noqa: E402
    LewisTier,
...
# =============================================================================
# BACKWARD-COMPATIBLE RE-EXPORTS FROM EXPERIMENTAL MODULE
# =============================================================================
# These functions have been moved to dataManipulation_experimental.py but are
# re-exported here so that existing imports continue to work.
from uct_benchmark.data.dataManipulation_experimental import (  # noqa: E402, F811
